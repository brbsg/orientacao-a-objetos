...
public class SaleScreen implements ListSelectionListener, ActionListener {
    ...
    public void mostrarDadosV(DataController d, int op) {
        dados = d;
        ...
        switch (op) {
            ...
            case 1:
                ...
                listaNomes = new SaleController(dados).getSaleName();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == cadastroVenda)
            new SaleInformationScreen().inserirEditar(1, dados, this, 0);

        // Atualiza a lista de nomes das vendas mostrada no JList
        if (src == refreshVenda) {
            listaVendasCadastradas.setListData(new SaleController(dados).getSaleName());
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (e.getValueIsAdjusting() && src == listaVendasCadastradas) {
            new SaleInformationScreen().inserirEditar(2, dados, this, listaVendasCadastradas.getSelectedIndex());
        }
    }
