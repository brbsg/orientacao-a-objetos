...
public class StoreInformationScreen implements ActionListener {
    ...
    public void inserirEditar(DataController d, StoreScreen l, int pos) {
        ...
        valorNome = new JTextField(dados.getStores()[pos].getNomeLoja(), 200);
        valorEndereco = new JTextField(dados.getStores()[pos].getEndereco(), 200);
        valorCEP = new JTextField(String.valueOf(dados.getStores()[pos].getCep()), 200);
        valorDDD = new JTextField(String.valueOf(dados.getStores()[pos].getTelefone().getDDD()), 3);
        valorTelefone = new JTextField(String.valueOf(dados.getStores()[pos].getTelefone().getNumero()), 10);
