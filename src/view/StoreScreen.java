...
public class StoreScreen implements ActionListener, ListSelectionListener {
    ...
    public void mostrarLoja(DataController dado) {
        dados = dado;
        listaNomes = new StoreController(dados).getNomeLojas();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == refreshLoja) {
            listaLojasCadastradas.setListData(new StoreController(dados).getNomeLojas());
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (e.getValueIsAdjusting() && src == listaLojasCadastradas) {
            new StoreInformationScreen().inserirEditar(dados, this, listaLojasCadastradas.getSelectedIndex());
        }
